   ...
   <div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0 font-size-18">{{__('main.Add Promotion')}}</h4>

            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">Pages</a></li>
                    <li class="breadcrumb-item active">{{__('main.Add Promotion')}}</li>
                </ol>
            </div>
            ...
            <div class="card-body">
                ...
                <form class="p-2" action="{{ route('promotion.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control float-number"  type="text" id="turnover" name="turnover" required   value="{{ old('turnover') }}">
                    ...
                    <div class="form-group">
                        <label for="image">{{__('main.Image (size 400x400px)')}}</label>
