            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="" aria-expanded="false">
                        ...
                        <li class=""><a href="{{ route('report.member-winlose') }}" class="active">Member Win/Loss</a></li>
                    </ul>
                </li>
                <li>
                ...
                <li>
                    <a href="Document_Lotto.pdf" target="_blank" class="waves-effect"><i class='bx bx-copy'></i><span>{{__('Lotto mannal')}}</span></a>
                </li>
                <li>
