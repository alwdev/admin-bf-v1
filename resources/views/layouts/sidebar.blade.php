            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                @if (json_decode(auth()->user()->permissions)->report > 1)
                    <li>
                        ...
                        <ul class="" aria-expanded="false">
                            ...
                            <li class=""><a href="{{ route('report.member-winlose') }}" class="active">Member
                                    Win/Loss</a></li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{ route('chat.index') }}" class="waves-effect"><i class='bx bx-chat'></i><span>Chat
                                List</span></a>
                    </li>
                @endif
                ...
                <li>
                    <a href="{{ route('smsLog.index') }}" class="waves-effect"><i
                            class='bx bx-copy'></i><span>Logs</span></a>
                </li>
            </ul>
        </div>
        <!-- Sidebar -->
