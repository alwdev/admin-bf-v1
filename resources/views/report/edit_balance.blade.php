                        ...
                        data-url="">
                            <thead>
                                <tr class="text-center">
                                    ...
                                    <th data-sortable="true">ยอดแก้ไข</th>
                                    <th data-field="name" data-filter-control="select" data-sortable="true">โดย</th>
                                    <th data-sortable="true">วันที่/เวลา</th>
                                    <th></th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($edit_balance as $member)
                                <tr>
                                    <td>{{ App\Http\Controllers\ReportController::member_detail($member->member_id) }}</td>
                                    <td class="text-center">{{ intval($member->balance) }}</td>
                                    <td class="text-center">{{ intval($member->edit_balance) }}</td>
                                    <td class="text-center">{{ App\Http\Controllers\ManageMemberController::staff_detail($member->user_id) }}</td>
