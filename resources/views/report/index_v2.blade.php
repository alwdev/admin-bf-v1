                    ...
                    <div>
                        ...
                        data-url="">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $member->playerUsername }}</td>
                                    <td>{{ $member->roundId == null ? '': $member->roundId}}</td>
                                    ...
                                    @if ( $member->eventName  == 'debit')
                                        <td class="text-center">เดิมพัน</td>
                                    @elseif ( $member->eventName  == 'credit' && $member->amount > 0 )
                                        <td class="text-center">จ่าย</td>
                                    @else
                                        <td class="text-center">{{ $member->eventName }}</td>
                                    @endif
