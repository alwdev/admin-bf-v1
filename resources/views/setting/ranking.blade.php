   ...
   <div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0 font-size-18">ตั้งค่าจัดอันดับ</h4>

            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">เพจ</a></li>
                    <li class="breadcrumb-item active">ตั้งค่าจัดอันดับ</li>
                </ol>
            </div>
...
<!-- end page title -->
        ...
        <div class="row">
            ...
            <div class="col-12 card">
                    ...
                    <div class="card-body">
                        <a type="button" class="btn btn-primary btn-gold waves-effect waves-light" href="#" data-toggle="modal" data-target="#staticBackdrop">เพิ่มจัดอันดับ
                        </a>
                                            ...
                                            <div class="modal-content">
                                              ...
                                              <div class="modal-body">
                                                  <form class="form-horizontal" id="form-add-level{{ $key }}" action="{{ route('setting.ranking_update') }}" method="post" enctype="multipart/form-data">
                                                      ...
                                                      <div class="mb-2">
                                                          <label class="" for="credit">รางวัล(เครดิต)</label>
                                                          <input type="text" class="form-control" name="credit" value="{{ $item->credit }}" @required(true)>
                                                      </div>
                                                      <div class="mb-2">
                                                          <label class="" for="diamond">รางวัล(เพชร)</label>
                                                          <input type="text" class="form-control" name="diamond"  value="{{ $item->diamond }}" @required(true)>
                                                      </div>
                                                      <div class="mb-2">
                                                          <label class="" for="exp">รางวัล(EXP)</label>
                                                          <input type="text" class="form-control" name="exp"  value="{{ $item->exp }}"  @required(true)>
                                                      </div>
                                                  </form>
                                              </div>
  ...
  <div class="modal fade" id="staticBackdrop" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered  modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form class="form-horizontal" id="form-add-level" action="{{ route('setting.ranking_create') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="mb-2">
                    <label class="" for="image">รูป</label>
                    <input type="file" class="form-control" name="image" accept="image/png, image/gif, image/jpeg">
                ...
                <div class="mb-2">
                    <label class="" for="credit">รางวัล(เครดิต)</label>
                    <input type="text" class="form-control" name="credit" @required(true)>
                </div>
                <div class="mb-2">
                    <label class="" for="diamond">รางวัล(เพชร)</label>
                    <input type="text" class="form-control" name="diamond" @required(true)>
                </div>
                <div class="mb-2">
                    <label class="" for="exp">รางวัล(EXP)</label>
