   ...
   <div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0 font-size-18">รายงานรายได้พันธมิตร</h4>

            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">เพจ</a></li>
                    <li class="breadcrumb-item active">รายงานรายได้พันธมิตร</li>
                </ol>
            </div>
                        ...
                        data-url="">
                            <thead>
                                <tr class="text-center">
                                    <th>ชื่อ Partner</th>
                                    <th data-sortable="true">รายได้</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $partner_com->members->username }}</td>
