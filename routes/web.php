...
Route::get('/test_partner_call_winlose/{id}', [App\Http\Controllers\PartnerController::class, 'test_partner_call_winlose']);
...
Route::get('/pghard_report/{start_day}/{end_day}', [App\Http\Controllers\PgHardController::class, 'pghard_report'])->name('pghard_report');
Route::get('/pghard_detail_report/{username}/{start_day}/{end_day}', [App\Http\Controllers\PgHardController::class, 'pghard_detail_report'])->name('report.pghard_detail');
